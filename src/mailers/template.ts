...
export const mfaSetupTemplate = (
  secretKey: string,
  brandColor: string = '#2563EB',
) => ({
  subject: 'Set up Two-Factor Authentication',
  text: `To set up two-factor authentication,
    on your account, use the following code: ${secretKey}`,
  html: `
      <html><head><style>
        body, html { margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f4f4f4; color: #333333; }
        .container { max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff; border-radius: 8px; box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.1); }
        ...
        <div class="container">
          ...
          <div class="content">
            ...
            <p>Thank you for choosing to secure your account with two-factor authentication. Use the following code to set up your account.</p>
            <p>Code: <strong>${secretKey}</strong></p>
